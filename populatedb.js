...
if (userArgs[0].indexOf('mongodb://') !== 0) {
...
function authorCreate(first_name, last_name, email, dob, cb) {
  authordetail = {first_name:first_name , last_name: last_name, email: email, dob: dob };
...
function createGenreAuthors(cb) {
    async.parallel([
        function(callback) {
          authorCreate('Patrick', 'Rothfuss','Patrick@localhost.com', '1973-06-06', callback);
        },
        function(callback) {
          authorCreate('Ben', 'Bova', 'Ben@localhost.com', '1932-11-8', callback);
        },
        function(callback) {
          authorCreate('Isaac', 'Asimov','Isaac@localhost.com', '1920-01-02', callback);
        },
        function(callback) {
          authorCreate('Bob', 'Billings','Bob@localhost.com', '1932-11-8', callback);
        },
        function(callback) {
          authorCreate('Jim', 'Jones', 'Jim@localhost.com', '1971-12-16', callback);
        },
        function(callback) {
